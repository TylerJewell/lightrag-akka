...
A `LICENSE-lightrag` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [HKUDS/LightRAG](https://github.com/HKUDS/LightRAG), Copyright
2025 LightRAG Team, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../lightrag-port/specs/SPEC-001-lightrag.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
